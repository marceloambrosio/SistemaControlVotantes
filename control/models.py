...
class Escuela(models.Model):
    ...
    def __str__(self):
        return self.nombre + " (" + self.direccion + ") - " + self.circuito.localidad + " (ID: " + str(self.id) + ")"
...
class Mesa(models.Model):
    ...
    def __str__(self):
        return "Mesa Nº " + str(self.num_mesa).zfill(4) + " - " + self.escuela.circuito.localidad + " - " + self.escuela.nombre + " (ID: " + str(self.id) + ")"
